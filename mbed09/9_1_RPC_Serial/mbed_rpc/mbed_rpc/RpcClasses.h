...
public:
    ...
    void set_baud(int a0) {o.set_baud(a0);} //baud --> set_baud
    ...
    virtual const struct rpc_method *get_rpc_methods() {
        static const rpc_method rpc_methods[] = {
            {"set_baud", rpc_method_caller<RpcSerial, int, &RpcSerial::set_baud>},//baud --> set_baud
    ...
    static struct rpc_class *get_rpc_class() {
        ...
        static rpc_class c = {"BufferedSerial", funcs, NULL}; //Serial --> BufferedSerial
        return &c;
    }
private:
    BufferedSerial o;
